	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" method="POST" action="inserir_registro.php">
					...
					<div class="wrap-input100 validate-input" data-validate="Username is required">
						...
						<input class="input100" type="text" name="tiposang" placeholder="Tipo Sanguíneo...">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<div class="login100-form-btn"><input type="submit"  value="Enviar" id="cadastrar" name="botao" onclick="return validar()">
